...
def box(data, x, y, labels=None, title="Box Plot", xlabel="Categories", ylabel="Values", ylim=None, log=False):
    ...
    if log:
        ...
        sns.boxplot(data=log_data, x=x, y=y)
...
def display_pvalue(x, y, **kwargs):
    ...
    # Add p-value to the plot with a larger font
    ax.text(0.5, 0.5, p_value_str, transform=ax.transAxes, ha='center', va='center', fontsize=20, color='red')
